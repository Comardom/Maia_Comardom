...
import PlasticThemeToggleIslandInEnglish from "../../PlasticThemeToggleIslandInEnglish.vue";
import UmbrellaMenuInEnglish from "./UmbrellaMenuInEnglish.vue";
		...
		<div :class="['top-bar', isDark ? 'dark' : 'light', ...breathingClasses]">
			...
			<div v-if="!isMobile" class="top-bar-content desktop">
				<div class="logo-title-wrapper">
					...
					<span class="title-text">HENU WEB STUDIO</span>
				</div>
				<div class="theme-toggle-wrapper">
					<a href="/nihilum" id="forum">FORUM</a>
			...
			<div v-else class="top-bar-content mobile">
				<div class="actions-left">
					<PlasticThemeToggleIslandInEnglish client:load />
				</div>
				<div class="center">
					<a href=""><img :src="logoSrc" alt="logo" class="logo" /></a>
				</div>
				<div class="actions-right">
					<UmbrellaMenuInEnglish client:load forumUrl="/nihilum" examUrl="/nihilum" deptHubUrl="/nihilum" />
				</div>
			</div>
