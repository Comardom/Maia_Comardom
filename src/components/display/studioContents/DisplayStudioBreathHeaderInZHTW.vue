...
import PlasticThemeToggleIslandInZHTW from "../../PlasticThemeToggleIslandInZHTW.vue";
import UmbrellaMenuInZHTW from "./UmbrellaMenuInZHTW.vue";
		...
		<div :class="['top-bar', isDark ? 'dark' : 'light', ...breathingClasses]">
			...
			<div v-if="!isMobile" class="top-bar-content desktop">
				<div class="logo-title-wrapper">
					...
					<span class="title-text">河南大學網站工作室</span>
				</div>
				<div class="theme-toggle-wrapper">
					<a href="/nihilum" id="forum">前往論壇</a>
			...
			<div v-else class="top-bar-content mobile">
				<div class="actions-left">
					<PlasticThemeToggleIslandInZHTW client:load />
				</div>
				<div class="center">
					<a href=""><img :src="logoSrc" alt="logo" class="logo" /></a>
				</div>
				<div class="actions-right">
					<UmbrellaMenuInZHTW client:load forumUrl="/nihilum" examUrl="/nihilum" deptHubUrl="/nihilum" />
				</div>
			</div>
