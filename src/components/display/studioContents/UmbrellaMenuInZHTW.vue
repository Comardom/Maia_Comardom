...
<template>
	<div v-if="isMobile()" class="umbrella-root">
		<button class="umbrella-btn" @click.stop="open = !open; permissionDenied = false;" :aria-expanded="open" aria-label="工具菜单">
		...
		<div v-if="open" class="popover" role="menu" aria-orientation="vertical">
			...
			<button class="pop-item" @click="triggerFloat">強制觸發漂浮</button>
